...
def get_org_password():
    """Get password from env, secrets, or default"""
    env_pw = os.environ.get("APP_PASSWORD", "").strip()
    if env_pw:
        return env_pw
    try:
        # Try to get from secrets, but don't fail if secrets.toml doesn't exist
        ...
        pass
    return "SPAR2024"  # Default password
...
# ============================================
# SIGN IN PAGE - Premium Centered Design
# ============================================
